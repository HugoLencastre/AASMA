...
public class NightHourDataset extends Dataset{

    private final double NORTH_PROB = 0.25;
    private final double SOUTH_PROB = 0.25;
    private final double WEST_PROB = 0.25;
    private final double EAST_PROB = 0.25;
    private final double spawnProb = 0.2;
